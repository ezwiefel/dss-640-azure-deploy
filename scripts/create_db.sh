...
wget https://raw.githubusercontent.com/ezwiefel/dss-640-azure-deploy/master/scripts/configure_db.sql -O /home/oracle/configure_db.sql

sqlplus sys/$sys_pass as sysdba @/home/oracle/configure_db.sql $sys_pass $db_user
